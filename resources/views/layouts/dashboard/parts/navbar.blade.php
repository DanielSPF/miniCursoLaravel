...
<div class="container-fluid">
    ...
    <a class="navbar-brand" @if(auth()->user()->is_admin) href="{{ route('admin.home') }}" @else href="{{ route('member.home') }}" @endif >@yield('title')</a>
    </div>
    ...
    <ul class="navbar-nav">
        ...
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <p>
            <span class="small">{{ auth()->user()->first_name }}</span>
            </p>
        </a>
